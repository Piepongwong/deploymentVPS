...
2. - [ ] create a VPS with Digital Ocean
...
## 1. Create a VPS with Digital Ocean
...
1. - [x] create a VPS with Digital Ocean :white_check_mark:
...
2. - [x] create a VPS with Digital Ocean 
